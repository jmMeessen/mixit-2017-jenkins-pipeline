...
** link:http://localhost:10000/gitserver[]
...
** or direct link: link:http://localhost:10000/gitserver/butler/demoapp[]
...
** link:http://localhost:10000/devbox[]
...
* Tests Reports put in the *`./target/surefire-plugin`* folder:
+
[source,subs="attributes",bash]
----
mvn test
...
----
* Check the application on the 10080 port:
** link:http://localhost:10080[]
...
* Tests Reports put in the *`./target/failsafe-plugin`* folder:
+
[source,subs="attributes",bash]
----
mvn verify
